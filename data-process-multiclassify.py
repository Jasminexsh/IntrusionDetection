...
Train_File_Multi_classify = r'data\kddcup.data_10_percent_corrected.csv'
Unlabeled_Test_File_Multi_classify = r'data\kddcup.testdata.unlabeled_10_percent.csv'
Labeled_Test_File_Multi_classify = r'data\corrected.csv'
...
def handle_label1(inputs):
    ...
    if inputs[41] in label_list1:
        return find_index2(inputs[41], label_list1)[0]
    """else:
...
def handle_label2(inputs):
    ...
    if inputs[41] in label_list2:
        return find_index3(inputs[41], label_list2)[0]
    """else:
        label_list.append(inputs[41])
